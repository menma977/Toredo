...
@section('content')
            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <a href="page_ready_article.html" class="widget">
                        ...
                        <div class="widget-image widget-image-sm">
                            <img src="{{ asset('admin') }}/img/placeholders/photos/photo9.jpg" alt="image">
                            <div class="widget-image-content">
                                <h2 class="widget-heading text-light"><strong>The autumn trip that changed my
                                        life</strong></h2>
                ...
                <div class="col-sm-6">
                    <a href="page_ready_article.html" class="widget">
                        ...
                        <div class="widget-image widget-image-sm">
                            <img src="{{ asset('admin') }}/img/placeholders/photos/photo19.jpg" alt="image">
                            <div class="widget-image-content">
                            ...
                            <div id="info-carousel" class="carousel slide remove-margin">
                                ...
                                <div class="carousel-inner">
                                    <div class="item active">
                                        <img src="{{ asset('admin') }}/img/placeholders/photos/photo11.jpg" alt="image">
                                    </div>
                                    <div class="item">
                                        <img src="{{ asset('admin') }}/img/placeholders/photos/photo12.jpg" alt="image">
                                    </div>
                                    <div class="item">
                                        <img src="{{ asset('admin') }}/img/placeholders/photos/photo2.jpg" alt="image">
                                    </div>
                                    <div class="item">
                                        <img src="{{ asset('admin') }}/img/placeholders/photos/photo8.jpg" alt="image">
                                    </div>
                                </div>
        ...
        <div class="col-lg-6 col-lg-pull-6">
            <div class="row">
                ...
                <div class="col-sm-6">
                    <a href="javascript:void(0)" class="widget">
                        <div class="widget-content themed-background-danger clearfix">
                            <img src="{{ asset('admin') }}/img/placeholders/avatars/avatar12.jpg" alt="avatar"
                                class="img-circle img-thumbnail img-thumbnail-avatar pull-right">
                ...
                <div class="col-sm-6">
                    <a href="javascript:void(0)" class="widget">
                        <div class="widget-content text-center">
                            <img src="{{ asset('admin') }}/img/placeholders/avatars/avatar6@2x.jpg" alt="avatar"
                        ...
                        <div class="widget-content">
                            <div class="row text-center">
                                <div class="col-xs-6">
                                    <h3 class="widget-heading"><i class="gi gi-picture text-success"></i> <br><small>350
                                            Photos</small></h3>
                                </div>
                                <div class="col-xs-6">
                                    <h3 class="widget-heading"><i class="gi gi-charts text-primary"></i> <br><small>4.2k
                                            Sales</small></h3>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-sm-6">
                    <a href="javascript:void(0)" class="widget">
                        <div class="widget-content text-center">
                            <img src="{{ asset('admin') }}/img/placeholders/avatars/avatar13@2x.jpg" alt="avatar"
                                class="img-circle img-thumbnail img-thumbnail-avatar-2x">
                        ...
                        <div class="widget-content">
                            <div class="row text-center">
                                <div class="col-xs-6">
                                    <h3 class="widget-heading"><i class="gi gi-briefcase text-info"></i> <br><small>35
                                            Projects</small></h3>
                                </div>
                                <div class="col-xs-6">
                                    <h3 class="widget-heading"><i class="gi gi-heart_empty text-danger"></i>
                                        <br><small>5.3k Likes</small>
                                    </h3>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-sm-12">
                    <div class="widget">
                        <div class="widget-image widget-image-xs">
                            <img src="{{ asset('admin') }}/img/placeholders/photos/photo13@2x.jpg" alt="image">
                            <div class="widget-image-content">
                            ...
                            <table class="table table-striped table-borderless remove-margin">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="text-center" style="width: 80px;"><span class="text-muted">2011</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><a href="javascript:void(0)" class="text-black">Breakind Bad</a></td>
                                        <td class="text-center" style="width: 80px;"><span class="text-muted">2008</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><a href="javascript:void(0)" class="text-black">True Detective</a></td>
                                        <td class="text-center" style="width: 80px;"><span class="text-muted">2014</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><a href="javascript:void(0)" class="text-black">Dexter</a></td>
                                        <td class="text-center" style="width: 80px;"><span class="text-muted">2006</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><a href="javascript:void(0)" class="text-black">Lost</a></td>
                                        <td class="text-center" style="width: 80px;"><span class="text-muted">2004</span>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                ...
                <div class="col-sm-12">
                    <div class="widget">
                        <div class="widget-image widget-image-xs">
                            <img src="{{ asset('admin') }}/img/placeholders/photos/photo18@2x.jpg" alt="image">
                            <div class="widget-image-content">
                            ...
                            <table class="table table-striped table-borderless remove-margin">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center" style="width: 80px;"><span class="text-muted">2013</span>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td><a href="javascript:void(0)" class="text-black">Amnesia: The Dark
                                                Descent</a></td>
                                        <td class="text-center" style="width: 80px;"><span class="text-muted">2010</span>
                                        </td>
                                    </tr>
                                    <tr>
    ...
    <div class="row">
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="widget">
                ...
                <div class="widget-content text-center">
                    <div class="pie-chart" data-percent="75" data-line-width="3" data-bar-color="#cccccc"
                        data-track-color="#f9f9f9">
                        <img src="{{ asset('admin') }}/img/placeholders/avatars/avatar4.jpg" alt="avatar"
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="widget">
                ...
                <div class="widget-content text-center">
                    <div class="pie-chart" data-percent="50" data-line-width="3" data-bar-color="#cccccc"
                        data-track-color="#f9f9f9">
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="widget">
                ...
                <div class="widget-content text-center">
                    <div class="pie-chart" data-percent="90" data-line-width="3" data-bar-color="#cccccc"
                        data-track-color="#f9f9f9">
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="widget">
                ...
                <div class="widget-content text-center">
                    <div class="pie-chart" data-percent="25" data-line-width="3" data-bar-color="#cccccc"
                        data-track-color="#f9f9f9">
            ...
            <div class="widget">
                <div class="widget-content themed-background-flat text-center">
                    <a href="javascript:void(0)">
                        <img src="{{ asset('admin') }}/img/placeholders/avatars/avatar4@2x.jpg" alt="avatar"
                            class="img-circle img-thumbnail img-thumbnail-avatar-2x">
                    </a>
                </div>
                <div class="widget-content themed-background-muted text-center">
                    <div class="btn-group">
                        <a href="javascript:void(0)" class="btn btn-effect-ripple btn-default"><i class="fa fa-share"></i>
                            Follow</a>
                        <a href="javascript:void(0)" class="btn btn-effect-ripple btn-default"><i
                                class="fa fa-suitcase"></i> Projects</a>
                    </div>
                </div>
                <div class="widget-content">
                    <div class="row text-center">
                        <div class="col-xs-4">
                            <h3 class="widget-heading"><small>PROJECTS</small><br><a href="javascript:void(0)"
                                    class="themed-color-flat">16</a></h3>
                        </div>
                        <div class="col-xs-4">
                            <h3 class="widget-heading"><small>LIKES</small><br><a href="javascript:void(0)"
                                    class="themed-color-flat">65k</a></h3>
                        </div>
                        <div class="col-xs-4">
                            <h3 class="widget-heading"><small>STORIES</small><br><a href="javascript:void(0)"
                                    class="themed-color-flat">9</a></h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="widget">
                <div class="widget-content themed-background-passion text-right clearfix">
                    <a href="javascript:void(0)" class="pull-left">
                        <img src="{{ asset('admin') }}/img/placeholders/avatars/avatar7@2x.jpg" alt="avatar"
                            class="img-circle img-thumbnail img-thumbnail-avatar-2x">
                    </a>
                ...
                <div class="widget-content themed-background-muted text-center">
                    <div class="btn-group">
                        <a href="javascript:void(0)" class="btn btn-effect-ripple btn-danger"><i class="fa fa-share"></i>
                            Follow</a>
                        <a href="javascript:void(0)" class="btn btn-effect-ripple btn-danger"><i class="fa fa-suitcase"></i>
                            Projects</a>
                    </div>
                </div>
                <div class="widget-content">
                    <div class="row text-center">
                        <div class="col-xs-4">
                            <h3 class="widget-heading"><small>PROJECTS</small><br><a href="javascript:void(0)"
                                    class="themed-color-passion">28</a></h3>
                        </div>
                        <div class="col-xs-4">
                            <h3 class="widget-heading"><small>LIKES</small><br><a href="javascript:void(0)"
                                    class="themed-color-passion">28k</a></h3>
                        </div>
                        <div class="col-xs-4">
                            <h3 class="widget-heading"><small>STORIES</small><br><a href="javascript:void(0)"
                                    class="themed-color-passion">19</a></h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="widget">
                <div class="widget-content themed-background-creme text-left clearfix">
                    <a href="javascript:void(0)" class="pull-right">
                        <img src="{{ asset('admin') }}/img/placeholders/avatars/avatar1@2x.jpg" alt="avatar"
                            class="img-circle img-thumbnail img-thumbnail-avatar-2x">
                    </a>
                ...
                <div class="widget-content themed-background-muted text-center">
                    <div class="btn-group">
                        <a href="javascript:void(0)" class="btn btn-effect-ripple btn-warning"><i class="fa fa-share"></i>
                            Follow</a>
                        <a href="javascript:void(0)" class="btn btn-effect-ripple btn-warning"><i
                                class="fa fa-suitcase"></i> Projects</a>
                    </div>
                </div>
                <div class="widget-content">
                    <div class="row text-center">
                        <div class="col-xs-4">
                            <h3 class="widget-heading"><small>PROJECTS</small><br><a href="javascript:void(0)"
                                    class="themed-color-creme">39</a></h3>
                        </div>
                        <div class="col-xs-4">
                            <h3 class="widget-heading"><small>LIKES</small><br><a href="javascript:void(0)"
                                    class="themed-color-creme">108k</a></h3>
                        </div>
                        <div class="col-xs-4">
                            <h3 class="widget-heading"><small>STORIES</small><br><a href="javascript:void(0)"
                                    class="themed-color-creme">35</a></h3>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-sm-4">
            <div class="widget">
                ...
                <div class="widget-content">
                    <div class="row text-center">
                        <div class="col-xs-6">
                            <h3 class="widget-heading"><i class="gi gi-book_open text-muted push"></i> <br><small>123
                                    Total Sales</small></h3>
                        </div>
                        <div class="col-xs-6">
                            <h3 class="widget-heading"><i class="gi gi-user_add text-muted push"></i> <br><small>+10%
                                    Clients</small></h3>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-sm-4">
            <div class="widget">
                ...
                <div class="widget-content">
                    <div class="row text-center">
                        <div class="col-xs-6">
                            <h3 class="widget-heading"><i class="gi gi-life_preserver text-muted push"></i>
                                <br><small>+30% Tickets</small>
                            </h3>
                        </div>
                        <div class="col-xs-6">
                            <h3 class="widget-heading"><i class="gi gi-check text-muted push"></i> <br><small>100%
                                    Resolved</small></h3>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-sm-4">
            <div class="widget">
                ...
                <div class="widget-content">
                    <div class="row text-center">
                        <div class="col-xs-6">
                            <h3 class="widget-heading"><i class="gi gi-wallet text-muted push"></i> <br><small>$670 in
                                    Wallet</small></h3>
                        </div>
                        <div class="col-xs-6">
                            <h3 class="widget-heading"><i class="gi gi-charts text-muted push"></i> <br><small>+10%
                                    Earnings</small></h3>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-8">
            <div class="widget">
                ...
                <div class="widget-content">
                    <div class="row text-center">
                        <div class="col-xs-4">
                            <h3 class="widget-heading"><i class="gi gi-book_open text-muted push"></i> <br><small>17k
                                    Sales</small></h3>
                        </div>
                        <div class="col-xs-4">
                            <h3 class="widget-heading"><i class="gi gi-wallet text-muted push"></i> <br><small>$41k
                                    Earnings</small></h3>
                        </div>
                        <div class="col-xs-4">
                            <h3 class="widget-heading"><i class="gi gi-life_preserver text-muted push"></i>
                                <br><small>3165 Tickets</small>
                            </h3>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-lg-4">
            <div class="widget">
                ...
                <div class="widget-content themed-background-muted">
                    <div class="row text-center">
                        <div class="col-xs-6">
                            <h3 class="widget-heading"><i class="gi gi-bug text-muted push"></i> <br><small>3 Open
                                    Tickets</small></h3>
                        </div>
                        <div class="col-xs-6">
                            <h3 class="widget-heading"><i class="gi gi-flag text-muted push"></i> <br><small>5
                                    Updates</small></h3>
                        </div>
                    </div>
                </div>
    ...
    <div class="row">
        ...
        <div class="col-lg-8">
            <div class="widget">
                <div class="widget-image widget-image-xs">
                    <img src="{{ asset('admin') }}/img/placeholders/photos/photo1@2x.jpg" alt="image">
                    <div class="widget-image-content">
                        <div class="widget-heading text-light h1 pull-right"><strong>16</strong>&deg; <span
                                class="text-light-op">C</span></div>
        ...
        <div class="col-lg-4">
            <div class="widget">
                <div class="widget-image widget-image-xs">
                    <img src="{{ asset('admin') }}/img/placeholders/photos/photo9@2x.jpg" alt="image">
                    <div class="widget-image-content">
                        <div class="widget-heading text-light h1 pull-right"><strong>9</strong>&deg; <span
                                class="text-light-op">C</span></div>
