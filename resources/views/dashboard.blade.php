                ...
                <div class="widget-content widget-content-full">
                    <div class="row text-center">
                        <div class="col-xs-4 push-inner-top-bottom border-right">
                            <h3 class="widget-heading"><i class="gi gi-wallet text-dark push-bit"></i>
                                <br><small>$ 41k</small>
                            </h3>
                        </div>
                        <div class="col-xs-4 push-inner-top-bottom">
                            <h3 class="widget-heading"><i class="gi gi-cardio text-dark push-bit"></i>
                                <br><small>17k Sales</small>
                            </h3>
                        </div>
                        <div class="col-xs-4 push-inner-top-bottom border-left">
                            <h3 class="widget-heading"><i class="gi gi-life_preserver text-dark push-bit"></i>
                                <br><small>3k+
                                    Tickets</small>
                            </h3>
                        </div>
        ...
        <div class="col-sm-6 col-lg-4">
            ...
            <a href="page_ready_profile.html" class="widget">
                ...
                <div class="widget-content border-bottom text-center themed-background-muted">
                    <{{ asset('admin') }} /img src="{{ asset('admin') }}/img/placeholders/avatars/avatar13@2x.jpg"
                        alt="avatar"
                        class="{{ asset('admin') }}/img-circle {{ asset('admin') }}/img-thumbnail {{ asset('admin') }}/img-thumbnail-avatar-2x">
        ...
        <div class="col-sm-4">
            ...
            <div class="widget">
                ...
                <a href="javascript:void(0)" class="widget-content themed-background-muted text-right clearfix">
                    <{{ asset('admin') }} /img src="{{ asset('admin') }}/img/placeholders/avatars/avatar6.jpg"
                        alt="avatar"
                        class="{{ asset('admin') }}/img-circle {{ asset('admin') }}/img-thumbnail {{ asset('admin') }}/img-thumbnail-avatar pull-left">
                ...
                <a href="javascript:void(0)" class="widget-content themed-background-muted border-top text-right clearfix">
                    <{{ asset('admin') }} /img src="{{ asset('admin') }}/img/placeholders/avatars/avatar2.jpg"
                        alt="avatar"
                        class="{{ asset('admin') }}/img-circle {{ asset('admin') }}/img-thumbnail {{ asset('admin') }}/img-thumbnail-avatar pull-left">
                ...
                <a href="javascript:void(0)" class="widget-content themed-background-muted border-top text-right clearfix">
                    <{{ asset('admin') }} /img src="{{ asset('admin') }}/img/placeholders/avatars/avatar11.jpg"
                        alt="avatar"
                        class="{{ asset('admin') }}/img-circle {{ asset('admin') }}/img-thumbnail {{ asset('admin') }}/img-thumbnail-avatar pull-left">
        ...
        <div class="col-sm-4">
            ...
            <div class="widget">
                ...
                <div class="widget-content widget-content-full-top-bottom border-bottom">
                    <div class="row text-center">
                        <div class="col-xs-6 push-inner-top-bottom border-right">
                            <h3 class="widget-heading"><i class="gi gi-book_open text-dark push"></i>
                                <br><small>123 Total Sales</small>
                            </h3>
                        </div>
                        <div class="col-xs-6 push-inner-top-bottom">
                            <h3 class="widget-heading"><i class="gi gi-user_add text-dark push"></i>
                                <br><small>+10% Clients</small>
                            </h3>
                        </div>
                    </div>
                </div>
                <div class="widget-content widget-content-full">
                    <div class="row text-center">
                        <div class="col-xs-6 push-inner-top-bottom border-right">
                            <h3 class="widget-heading"><i class="gi gi-briefcase text-dark push"></i>
                                <br><small>5 Products</small>
                            </h3>
                        </div>
                        <div class="col-xs-6 push-inner-top-bottom">
                            <h3 class="widget-heading"><i class="gi gi-truck text-dark push"></i>
                                <br><small>10 Deliveries</small>
                            </h3>
                        </div>
                    </div>
                </div>
